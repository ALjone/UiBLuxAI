...
class Agent():
    ...
    def act(self, state, remainingOverageTime: int = 60):
        ...
        return outputs_to_actions(unit_output.detach().cpu(), factory_output.detach().cpu(), units, factories, obs, factory_map = image_features[1]) #Second channel is always factory_map
