...
import numpy as np
import scipy
from actions.lux_action import outputs_to_actions, UNIT_ACTION_IDXS, FACTORY_ACTION_IDXS
from ppo import PPO
import torch
...
class Agent():
    ...
    def act(self, state, remainingOverageTime: int = 60):
        ...
        unit_output, factory_output = self.PPO.select_action(image_features, global_features, obs, self.player)
