...
def jux_action(unit_output0, factory_output0, unit_output1, factory_output1, state):
    ...
    for i, (unit_possies, factory_possies, unit_ids, unit_id2idxs, factory_id2idxs, factory_ids, unit_outputs0, factory_outputs0, unit_outputs1, factory_outputs1, n_units, n_factories) in \
        ...
        factory_actions, unit_actions, unit_action_queue_update = __jux_action_single_env(unit_output0, factory_output0, unit_output1, 
                factory_output1, unit_id2idx, factory_id2idx, unit_possies, factory_possies, unit_ids, factory_ids, n_units, n_factories)
    ...
    unit_action = UnitAction(batched_unit_actions[..., 0], batched_unit_actions[..., 1], batched_unit_actions[..., 2],
                             batched_unit_actions[..., 3], batched_unit_actions[..., 4], batched_unit_actions[..., 5])

    return JuxAction(batched_factory_actions, unit_actions, batched_unit_action_queue_count, batched_unit_action_queue_update)
...
def __jux_action_single_env_single_player(unit_output, unit_possies, unit_ids, unit_id2idx, factory_outputs, factory_possies, factory_ids, factory_id2idx, n_units, n_factories):
    ...
    for i in range(n_factories):
        action = __jux_action_single_env_single_factory(factory_output[factory_possies[i, 0], factory_possies[i, 1]])
        idx = factory_id2idx[unit_id[i]]
...
def __jux_action_single_env_single_factory(action_idx):
    if action_idx == 0:
        ...
        return FactoryAction.GROW_LICHEN
    else:
...
action_map = {
                            ...
                            (0,1,0,0,0,0):1, #Move north
                            (0,2,0,0,0,0):2, #Move east
                            (0,3,0,0,0,0):3, #Move south
                            (0,4,0,0,0,0):4, #Move west
                            (1,1,0,0,0,0):5,# Transfer Ice North
                            (1,2,0,0,0,0):6,# Transfer Ice east
                            (1,3,0,0,0,0):7,# Transfer Ice south
                            (1,4,0):8,# Transfer Ice west

                            (1,1,1,1,0,0):9,# Transfer ore North
                            (1,2,1,1,0,0):10,# Transfer ore east
                            (1,3,1,1,0,0):11,# Transfer ore south
                            (1,4,1,1,0,0):12,# Transfer ore west

                            (1,1,2,1,0,0):13,# Transfer Water North
                            (1,2,2,1,0,0):14,# Transfer Water east
                            (1,3,2,1,0,0):15,# Transfer Water south
                            (1,4,2,1,0,0):16,# Transfer Water west

                            (1,1,4,0,0,0):17,# Transfer Power North 25%
                            (1,1,4,1,0,0):18,# Transfer Power North 50%
                            (1,1,4,2,0,0):19,# Transfer Power North 75%
                            (1,1,4,3,0,0):20,# Transfer Power North 100%

                            (1,2,4,0,0,0):21,# Transfer Power east 25%
                            (1,2,4,1,0,0):22,# Transfer Power east 50%
                            (1,2,4,2,0,0):23,# Transfer Power east 75%
                            (1,2,4,3,0,0):24,# Transfer Power east 100%

                            (1,3,4,0,0,0):25,# Transfer Power south 25%
                            (1,3,4,1,0,0):26,# Transfer Power south 50%
                            (1,3,4,2,0,0):27,# Transfer Power south 75%
                            (1,3,4,3,0,0):28,# Transfer Power south 100%

                            (1,4,4,0,0,0):29,# Transfer Power west 25%
                            (1,4,4,1,0,0):30,# Transfer Power west 50%
                            (1,4,4,2,0,0):31,# Transfer Power west 75%
                            (1,4,4,3,0,0):32,# Transfer Power west 100%

                            (2,0,4,1,0,0):33,# Pickup Power
                            (2,0,0,0,0,0):34,# Pickup ice
                            (2,0,1,0,0,0):35,# Pickup ore
                            (2,0,2,0,0,0):36,# Pickup water
                            (3,0,0,0,0,0):37,# digg
                            (4,0,0,0,0,0):38,# Self Destruct
