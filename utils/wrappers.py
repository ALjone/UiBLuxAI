    ...
    def observation(
        ...
        for agent in obs.keys():
            ...
            for unit_id in units.keys():
                ...
                #    [unit["pos"]/self.env.state.env_cfg.map_size, [unit_type], cargo_vec, [unit["team_id"]]], axis=-1
                #)
                unit_vec = cargo_vec
            ...
            for unit_id in factories.keys():
                ...
                factory_data[factory["pos"][0], factory["pos"][1]] = factory["team_id"]
...
class SinglePlayerEnv(gym.Wrapper):
    ...
    def get_reward(self, action, obs):
        ...
        unit = units[next(iter(units.keys()))]
        ...
        if reward > 0 and self.env_cfg.verbose > 0:
            print("Move to ice reward", unit_move_to_ice_reward)
            print("Deliver ice reward", unit_deliver_ice_reward)
            print("Mining reward", unit_mining_reward)
            print()
